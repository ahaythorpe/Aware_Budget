...
let allBiasPatterns: [BiasPattern] = [
    ...
    BiasPattern(
        ...
        nudgeSays: "Just opening GoldMind beats the avoidance pattern. Most people look away. You're looking.",
    ...
    BiasPattern(
        ...
        nudgeSays: "Losing $50 feels twice as bad as gaining $50 feels good. Same dollar amount, double the sting. That's why people hold bad investments, avoid reviewing debt, accept bad deals just to dodge the pain of switching.",
    ...
    BiasPattern(
        ...
        nudgeSays: "Money already spent is gone. Spending more won't bring it back. The only question now: what's the best move from here?",
        keyRef: "Thaler, 1980",
    ...
    BiasPattern(
        ...
        nudgeSays: "Tax refund money and salary money are identical. Refunds get spent faster though. Treating them as the same resource is the unlock.",
        keyRef: "Thaler, 1985",
    ...
    BiasPattern(
        ...
        nudgeSays: "Most default super funds, insurance providers, and subscription plans were chosen by someone else. Status quo bias keeps you there long after switching would help.",
    ...
    BiasPattern(
        ...
        nudgeSays: "Going to the gym makes you feel like you earned the Uber Eats. One good financial decision can unconsciously license another bad one to follow.",
