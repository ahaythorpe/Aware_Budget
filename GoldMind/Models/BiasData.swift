...
let allBiasPatterns: [BiasPattern] = [
    ...
    BiasPattern(
        ...
        nudgeSays: "The pain of losing $50 registers like losing $100. That's why people hold bad investments. Avoid reviewing debt. Accept bad deals just to avoid the sting of switching.",
