...
enum BiasRelationships {
    static let related: [String: [String]] = [
        ...
        "Availability Heuristic":["Social Proof", "Bandwagon Effect"],
        ...
        "Social Proof":          ["Bandwagon Effect", "Availability Heuristic"],
        "Bandwagon Effect":    ["Social Proof", "Availability Heuristic"],
